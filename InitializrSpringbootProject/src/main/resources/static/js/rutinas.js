...
//funcion para mostrar el toast de consulta
function mostrarConsultaToast(event) {
    if (event)
        event.preventDefault();

    const toastElement = document.getElementById('consultaToast');
    if (!toastElement) {
        console.warn('consultaToast no existe en esta página');
        return;
    }
